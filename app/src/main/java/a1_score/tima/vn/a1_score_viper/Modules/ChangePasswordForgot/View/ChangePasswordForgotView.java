package a1_score.tima.vn.a1_score_viper.Modules.ChangePasswordForgot.View;
...
import a1_score.tima.vn.a1_score_viper.Modules.ChangePasswordForgot.Presenter.ChangePasswordForgotPresenter;
import a1_score.tima.vn.a1_score_viper.R;
import butterknife.BindView;
import butterknife.ButterKnife;

public class ChangePasswordForgotView extends AppCompatActivity implements ChangePasswordForgotInterface.View, View.OnClickListener {
    ...
    private ChangePasswordForgotInterface.Presenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new ChangePasswordForgotPresenter(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btChangePass:
                presenter.changePass(getIntent().getStringExtra("PHONE_NUMBER"), etPassword.getText().toString(), etRePassword.getText().toString(), getIntent().getStringExtra("TOKEN"));
                break;
        }
    }
